        ...
        <table class="table">
            ...
            <?php foreach($users as $user): ?>
                ...
                <td><?php echo $user->first_name;?></td><td><?php echo $user->last_name;?></td>
                    ...
                    <td><a class="btn btn-danger rounded-0" href="user_softdelete.php?id=<?php echo $user->id;
                        ?>"><i class="far fa-edit"></i></a></td>
                    <td><a class="btn btn-danger rounded-0" href="user_undelete.php?id=<?php echo $user->id;
                        ?>"><i class="far fa-edit"></i></a></td>
                </tr>
            <?php endforeach; ?>
